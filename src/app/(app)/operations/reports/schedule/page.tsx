import { getMoveInScheduleReport } from "@/lib/actions/move-in-reports";
...
export default async function MoveInScheduleReportPage() {
  const [rows, locale] = await Promise.all([getMoveInScheduleReport(), getLocale()]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between no-print">
        <h1 className="text-2xl font-bold text-slate-900">{t.operations.reportSchedule}</h1>

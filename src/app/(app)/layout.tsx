...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const allNavItems: Array<{ href: string; label: string; icon: string; permission: Permission }> = [
    ...
    { href: "/documents", label: t.documents.navTitle, icon: "📁", permission: "document.view" },
    ...
    { href: "/settings/users", label: t.nav.usersAndPermissions, icon: "👤", permission: "staffUser.view" },
  ];
